...
proc emeteur_regulation {plugNumber} {
    ...
    if {[lindex $programmeToSend $plugNumber] != "off" && [lindex $programmeToSend $plugNumber] != "on"} {
        ::piLog::log [clock milliseconds] "info" "regulation plug $plugNumber programme [lindex $programmeToSend $plugNumber]"
    }
...
proc updatePlug {plugNumber} {
    ...
    if {[lindex $programmeToSend $plugNumber] != "off" && [lindex $programmeToSend $plugNumber] != "on"} {
        ...
        ::piLog::log [clock milliseconds] "info" "update plug $plugNumber with programm [lindex $programmeToSend $plugNumber]"
    }

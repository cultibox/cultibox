...
INSERT INTO `configuration` (`id`, `VERSION`, `COLOR_HUMIDITY_GRAPH`, `COLOR_TEMPERATURE_GRAPH`, `COLOR_WATER_GRAPH`, `COLOR_LEVEL_GRAPH`, `COLOR_PH_GRAPH`, `COLOR_EC_GRAPH`, `COLOR_OD_GRAPH`, `COLOR_ORP_GRAPH`, `RECORD_FREQUENCY`, `POWER_FREQUENCY`, `NB_PLUGS`, `UPDATE_PLUGS_FREQUENCY`, `ALARM_ACTIV`, `ALARM_VALUE`, `COST_PRICE`, `COST_PRICE_HP`, `COST_PRICE_HC`, `START_TIME_HC`, `STOP_TIME_HC`, `COST_TYPE`, `STATISTICS`,`ADVANCED_REGUL_OPTIONS`,`SHOW_COST`,`RESET_MINMAX`, `RTC_OFFSET`) VALUES
(1, '1.1.28', 'blue', 'red', 'orange', 'pink', 'brown', 'yellow', 'red', 'blue', 1, 1, 3, 1, '0000', '60', 0.1225, 0.1353, 0.0926, '22:30', '06:30', 'standard', 'True', 'False', 0, '00:00',0);
...
(1, '', 'Prise1', 'other', 1.0, NULL, '3500', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(2, '', 'Prise2', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(3, '', 'Prise3', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(4, '', 'Prise4', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(5, '', 'Prise5', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(6, '', 'Prise6', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(7, '', 'Prise7', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(8, '', 'Prise8', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(9, '', 'Prise9', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(10, '', 'Prise10', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(11, '', 'Prise11', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(12, '', 'Prise12', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(13, '', 'Prise13', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(14, '', 'Prise14', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(15, '', 'Prise15', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(16, '', 'Prise16', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(17,'', 'Prise17', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(18,'', 'Prise18', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(19,'', 'Prise19', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(20,'', 'Prise20', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(21,'', 'Prise21', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(22,'', 'Prise22', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(23,'', 'Prise23', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(24,'', 'Prise24', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(25,'', 'Prise25', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(26,'', 'Prise26', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(27,'', 'Prise27', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(28,'', 'Prise28', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(29,'', 'Prise29', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(30,'', 'Prise30', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(31,'', 'Prise31', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(32,'', 'Prise32', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(33,'', 'Prise33', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(34,'', 'Prise34', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless'),
(35,'', 'Prise35', 'other', 1.0, NULL, '1000', 'False', '1', 'T', '+', 35.0,0.0,'M','wireless');
...
INSERT INTO `program_index` (`name`,`version`,`program_idx`,`creation`, `modification`, `plugv_filename`,`comments`) VALUES('Courant','1.0','1' , NOW(), NOW(), '00' , "Programme courant");

...
CREATE TABLE IF NOT EXISTS `configuration` (
  ...
  `VERSION` varchar(30) NOT NULL DEFAULT '1.1.7',
...
(1, 'False', '1.1.7', 'blue', 'red', 'black', 'purple', 5, 1, 3, -1, 'en_GB', 60, 100, 1000, 'True', '0000', '15', '000H', '000+', 0.1225, 0.1353, 0.0926, '22:30', '06:30', 'standard', 2, 'True');

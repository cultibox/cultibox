...
CREATE TABLE IF NOT EXISTS `configuration` (
  ...
  `SHOW_WIZARD` VARCHAR( 5 ) NOT NULL DEFAULT 'True',
...
(1, 'True', '1.1.9', 'blue', 'red', 'black', 'purple', 5, 1, 3, -1, 'True', '0000', '15', 0.1225, 0.1353, 0.0926, '22:30', '06:30', 'standard', 2, 'True', 'False', 'False', 'False', 'True', 'False');

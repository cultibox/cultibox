...
CREATE TABLE IF NOT EXISTS `configuration` (
  ...
  `RESET_MINMAX` VARCHAR( 8 ) NOT NULL DEFAULT '00:00:00',
  PRIMARY KEY (`id`)
...
(1, 'True', '1.1.28', 'blue', 'red', 'black', 'purple', 5, 1, 3, -1, 'True', '0000', '15', 0.1225, 0.1353, 0.0926, '22:30', '06:30', 'standard', 'True', 'False', 'False', 'False', 'False','00:00:00');

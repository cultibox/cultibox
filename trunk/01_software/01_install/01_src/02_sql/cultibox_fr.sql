...
CREATE TABLE IF NOT EXISTS `configuration` (
  ...
  `VERSION` varchar(30) NOT NULL DEFAULT '1.1.8',
...
(1, 'False', '1.1.8', 'blue', 'red', 'black', 'purple', 5, 1, 3, -1, 'fr_FR', 60, 100, 1000, 'True', '0000', '15', '000H', '000+', 0.1225, 0.1353, 0.0926, '22:30', '06:30', 'standard', 2, 'True');

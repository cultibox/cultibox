...
CREATE TABLE IF NOT EXISTS `configuration` (
  ...
  `VERSION` varchar(30) NOT NULL DEFAULT '1.0.303',
...
(1, 'False', '1.0.303', 'blue', 'red', 'black', 'green', 'purple', 5, 1, 3, -1, 'fr_FR', 50, 100, 1000, 'True', '0000', '50.0', '000H', '000+', 0.1249, 0.1353, 0.0926, '22:30', '06:30', 'standard', 2);

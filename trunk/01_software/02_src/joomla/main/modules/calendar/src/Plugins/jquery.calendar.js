    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push('<table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td align="center" class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div>');
                temparr.push('<td align="center" class="bubble-cell-main"><div class="bubble-top"></div><td align="center" class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td align="center" class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root">');
                temparr.push('<table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><th class="cb-key"><img src="css/images/edit_details.png" alt="event" /> ');
                temparr.push('</th><td align="center" class=cb-value></td></tr><tr><th class="cb-key">');
                temparr.push('</th><td align="center" class="cb-value"><div class="cb-example">');
                ...
                temparr.push('<SPAN id="bbit-cal-editLink" class="lk">');

...
$(document).ready(function(){
     ...
     $.ajax({
        ...
        var version="<p class='p_center'><b><i><?php echo __('CULTIPI_SOFT_VERSION'); ?>:</i></b></p><br /><?php echo __('CULTIPI_SOFT'); ?>:  <b>"+objJSON[0]+"</b><br /><?php echo __('CULTINET_SOFT'); ?>:  <b>"+objJSON[1]+"</b><br /><?php echo __('CULTIBOX_SOFT'); ?>:  <b>"+objJSON[2]+"</b><br /><?php echo __('CULTIRAZ_SOFT'); ?>:  <b>"+objJSON[3]+"</b><br /><?php echo __('CULTITIME_SOFT'); ?>:  <b>"+objJSON[4]+"</b>";
